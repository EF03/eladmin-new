...
//        redisUtils.set(properties.getOnlineKey() + token, onlineUserDto, properties.getTokenValidityInSeconds()/1000);
        redisUtils.setCacheObject(properties.getOnlineKey() + token, onlineUserDto, properties.getTokenValidityInSeconds() / 1000, TimeUnit.SECONDS);
    }
...
//            OnlineUserDto onlineUserDto = (OnlineUserDto) redisUtils.get(key);
            OnlineUserDto onlineUserDto = redisUtils.getCacheObject(key);
